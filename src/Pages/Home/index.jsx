  ...
  <> 
    <div className='home' id='home'>
      ...
      <div className='nav-links'>
        <span className='hidden' onClick={() => scrollToSection("about")}>
              About Me
        </span>
        <span className='hidden' onClick={() => scrollToSection("projects")}>
              My Projects
        </span>
        <span className='hidden' onClick={() => scrollToSection("contact")}>
              Contact Me
        </span>
      </div>
